...
#define APP_TIMER_INT_LEVELS         3                          /**< Number of interrupt levels from where timer operations may be initated (only for use inside APP_TIMER_BUF_SIZE()). */
 ...
 * @param[in]  PRESCALER   Value of the RTC1 prescale register (must be the same value that was
