...
//
//
//  MultiConfigScrollerController.m
//  NordicSemiDemo
//
...
@interface MultiConfigScrollerController(PrivateMethods)
- (void)loadScrollViewWithPage:(int)page;
- (void)scrollViewDidScroll:(UIScrollView *)sender;
- (void)back:(id)sender;
@end

@implementation MultiConfigScrollerController

@synthesize scrollView, pageControl, viewControllers, contentArray, configHelp;
...
- (void)loadScrollViewWithPage:(int)page
{
    ...
    {
        controller = [contentArray objectAtIndex:page];
