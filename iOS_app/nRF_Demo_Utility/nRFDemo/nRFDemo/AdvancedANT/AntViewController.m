...
- (void)viewDidLoad
{
	...
	[rxMessageView setFont:[UIFont fontWithName:@"Courier" size: 9.5]];
	rxMessageView.text = @"";
...
- (void)antMessageReceived:(WFAntMessage)antMessage
{
	...
	NSString* msg = [NSString stringWithFormat:@"%02X %02X %02X [%02X %02X %02X %02X %02X %02X %02X %02X] %02X [%02X %02X %02X %02X]\n",
