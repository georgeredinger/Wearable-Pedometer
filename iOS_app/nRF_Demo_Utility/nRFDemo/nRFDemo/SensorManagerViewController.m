...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"Stored Sensor Info";
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    BOOL bAnt = (usAllowedNetworks & WF_NETWORKTYPE_ANTPLUS) ? TRUE : FALSE;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ( tableView == pairedTable )
    {
        ...
        cell.textLabel.text = [NSString stringWithFormat:@"ID: %@", (devParams.networkType==WF_NETWORKTYPE_BTLE)?[WFSensorCommonViewController formatUUIDString:devParams.deviceUUIDString] : devParams.deviceIDString];
        ...
        {
            cell.detailTextLabel.text = [NSString stringWithFormat:@"Suunto TransmissionType: %u", devParams.transmissionType];
        }
    }
    //
    ...
    else
    {
        ...
        if ( devParams.networkType == WF_NETWORKTYPE_BTLE )
        {
            cell.textLabel.text = [WFSensorCommonViewController formatUUIDString:devParams.deviceUUIDString];
        }
        else
        {
